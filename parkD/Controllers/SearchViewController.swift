...
class SearchViewController: UIViewController, UISearchBarDelegate {
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        if (segue.identifier == searchToFilter) {
            ...
            let filterData = FilterData(validFilter: validZoneActive, distanceFilter: closestDistanceActive, destination: twoDdestination)
            filterController.setData(data: filterData)
        }
    }
}
